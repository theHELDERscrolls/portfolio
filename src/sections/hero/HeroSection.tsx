...
export const HeroSection = () => {
  return (
    <section
      id="hero"
      className="flex items-center justify-center w-full min-h-[var(--section-min-height)] bg-neutral-100 px-[var(--section-px)] md:px-[var(--section-px-md)] py-[var(--section-py)]"
    >
